        ...
        <div className="min-h-screen flex flex-col bg-slate-900">
            ...
            <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute inset-0 bg-gradient-to-b from-slate-900/70 via-slate-900/50 to-slate-900 z-10" />
                    <video
                        autoPlay
                        loop
                        muted
                ...
                <div className="relative z-20 text-center px-4 max-w-5xl mx-auto pt-12">
                    ...
                    >
                        <span className="inline-block px-4 py-2 rounded-full border border-blue-400/30 bg-blue-500/10 text-blue-300 text-sm md:text-base font-medium tracking-widest uppercase mb-6 backdrop-blur-md shadow-lg">
                            Live Tennis Intelligence
                        </span>
                        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-white tracking-tighter leading-none mb-6 drop-shadow-2xl">
                            GAME.<br />
                    ...
                    >
                        <button
                            ...
                            className="group relative px-10 py-5 bg-white text-slate-950 rounded-full font-bold text-xl hover:bg-blue-50 transition-all transform hover:scale-105 shadow-[0_0_50px_-10px_rgba(255,255,255,0.4)]"
                        >
            ...
            <Section className="bg-slate-950/50 py-32 border-y border-slate-800/50">
                <div className="container mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        <h2 className="text-5xl md:text-7xl font-black text-white mb-6">Global Coverage</h2>
                    ...
                    >
                        ...
                        {['US', 'ES', 'GB', 'FR', 'AU', 'IT', 'RS', 'IN', 'DE', 'JP', 'BR', 'CA'].map((code, i) => (
                            <motion.div
                                ...
                                className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50 hover:bg-slate-800 hover:border-blue-500/50 transition-all cursor-pointer"
                            >
                                <img
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="relative group">
                                ...
                                <img
                                    ...
                                    alt="Tennis Player"
                                    className="relative rounded-2xl shadow-2xl border border-slate-700 transform transition-transform duration-500 group-hover:scale-[1.02]"
                                />
                                <div className="absolute bottom-6 left-6 right-6 bg-slate-900/90 backdrop-blur-md p-6 rounded-xl border border-slate-700/50">
                                    <div className="flex justify-between items-end">
                                        <div>
                                            <div className="text-yellow-400 font-bold mb-1">PLAYER SPOTLIGHT</div>
                                            <div className="text-2xl font-bold text-white">Carlos Alcaraz</div>
                                        </div>
                        ...
                        >
                            ...
                            <button
                                ...
                                className="bg-slate-800 text-white px-8 py-4 rounded-xl font-bold hover:bg-slate-700 transition-colors border border-slate-700 hover:border-yellow-500/50 flex items-center"
                            >
